                ...
                {/* body */}
                {
                  ...
                  (
                    ...
                    <div className='flex relative h-[26vh]'>
                      <Image
                        imageSrc={`${IMAGE_URL}${latestLprDetect?.vehicle_image_url}`}
                        imageAlt={`Vehicle Image`}
                        className='w-full h-full'
                      />
                      <Image
                        imageSrc={`${IMAGE_URL}${latestLprDetect?.plate_image_url}`}
                        imageAlt={`Plate Image`}
                        className='w-[200px] h-[10vh] absolute bottom-0'
                      />
                    </div>
                      ...
                      <table className='text-[13.5px] w-full text-white'>
                        <tbody>
                          ...
                          <tr className='border-b-[1px] border-dashed border-darkGray h-[45px]'>
                            ...
                            <td className='bg-tuna p-2 w-[416px]'>{latestLprDetect?.camera_info ? latestLprDetect?.camera_info.camera_name : ""}</td>
                          </tr>
                          <tr className='border-b-[1px] border-dashed border-darkGray h-[45px]'>
                            ...
                            ? lprDetectHistoryList.map((data, index) => (
                              ...
                              >
                                ...
                                <td className="bg-celtic text-center">
                                  <div>
                                    <Image
                                      key={`${index}_vehicle_image`}
                                      imageSrc={`${IMAGE_URL}${data.vehicle_image_url}`}
                                      imageAlt={`${index}_vehicle_image`}
                                      className="inline-flex items-center justify-center align-middle h-[65px] w-[60px]"
                                    />
                                    <Image
                                      key={`${index}_plate_image`}
                                      imageSrc={`${IMAGE_URL}${data.plate_image_url}`}
                                      imageAlt={`${index}_plate_image`} 
                                      className="inline-flex items-center justify-center align-middle h-[65px] w-[60px]"
                                    />
                                  </div>
                                </td>
                                <td className="bg-tuna pl-2">{data.camera_info ? data.camera_info.camera_name : ""}</td>
