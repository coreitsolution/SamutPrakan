...
const ManageCheckpointCameras: React.FC<ManageCheckpointCamerasProps> = ({}) => {
  ...
  const checkAllRequestDeleteCamera = () => {
    const allSelectedIds = requestDeleteCameraData.map((data) => data.uid);
  ...
  const checkAllDeletedCamera = () => {
    const allSelectedIds = deletedCameraData.map((data) => data.uid);
                          ...
                          >
                            <TableCell sx={{ backgroundColor: "#48494B", color: "#FFFFFF", height: "83px", textAlign: "center" }}>
                              <div className="flex items-center justify-center">
                                <Checkbox
                                  ...
                                  checked={requestDeleteCameraSelectId.includes(data.uid)}
                                  onChange={() =>  checkRequestDeleteCamera(data.uid)}
                                />
                              </div>
                            </TableCell>
                            ...
                            <TableCell sx={{ backgroundColor: "#393B3A", color: "#FFFFFF", height: "83px", textAlign: "center" }}>
                              <IconButton 
                                ...
                                onClick={() => handleApproveSelectCamera(data.uid)}
                              >
                                <img src="/svg/approve-icon.svg" alt="Approve Icon" className='w-6 h-6' />
                              </IconButton>
                            </TableCell>
                            <TableCell sx={{ backgroundColor: "#48494B", color: "#FFFFFF", height: "83px", textAlign: "center" }}>
                              <IconButton 
                                ...
                                onClick={() => handleUnapproveSelectCamera(data.uid)}
                              >
                                <img src="/svg/unapprove-icon.svg" alt="Unapprove Icon" className='w-6 h-6' />
                              </IconButton>
                            </TableCell>
                            ...
                            >
                              <TableCell sx={{ backgroundColor: "#48494B", color: "#FFFFFF", height: "83px", textAlign: "center" }}>
                                <div className="flex items-center justify-center">
                                  <Checkbox
                                    ...
                                    checked={deletedCameraSelectId.includes(data.uid)}
                                    onChange={() =>  checkDeletedCamera(data.uid)}
                                  />
                                </div>
                              </TableCell>
                              <TableCell sx={{ backgroundColor: "#393B3A", color: "#FFFFFF", height: "83px", textAlign: "center" }}>
                              ...
                              <TableCell sx={{ backgroundColor: "#48494B", color: "#FFFFFF", height: "83px", textAlign: "center" }}>
                                <Button
                                  ...
                                  onClick={() => handleActiveSelectCamera(data.uid)}
                                >
                                  {t('button.camera-active')}
                                </Button>
                              </TableCell>
